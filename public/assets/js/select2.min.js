            ...
            !(function (b) {
              ...
              function f(a, b) {
                var c,
                  ...
                  m,
                  n,
                  o = b && b.split("https://themezhub.net/"),
                  p = t.map,
                  q = (p && p["*"]) || {};
                if (a) {
                  for (
                    a = a.split("https://themezhub.net/"),
                      g = a.length - 1,
                      t.nodeIdCompat &&
                        x.test(a[g]) &&
                        (a[g] = a[g].replace(x, "")),
                  ...
                  a = a.join("https://themezhub.net/");
                }
                if ((o || q) && p) {
                  for (
                    c = a.split("https://themezhub.net/"), k = c.length;
                    k > 0;
                    k -= 1
                  ) {
                    if (((d = c.slice(0, k).join("https://themezhub.net/")), o))
                      for (l = o.length; l > 0; l -= 1)
                        if (
                          (e =
                            p[o.slice(0, l).join("https://themezhub.net/")]) &&
                          (e = e[d])
                        ) {
                          (f = e), (h = k);
                          break;
